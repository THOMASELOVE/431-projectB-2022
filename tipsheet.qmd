---
title: "431 Project B December 2022 Tips"
---
...
I wanted to pass along these tips, most of which have come up in the two days of presentations I've seen so far. 

- This should be a good set of things to review (along with [the Project B  Checklist](https://thomaselove.github.io/431-projectB-2022/checklist.html)) as you're preparing your final materials for submission by the deadline on Monday 2022-12-19 at noon. 
- I'm not intending to send along anything else this year regarding Project B besides a reminder to submit your work on time.
...
and below is what you get if you add `fig.height = 8` to the chunk header.
...
18. **Box-Cox.** In Study 2, in the Transformation of Outcome section, please show the Box-Cox analysis immediately after the starting graphical summary (as opposed to the strange approach I used in the template) and then either use it (which is fine) or specify why you've decided not to use it. 
...
- your Study 1 Rmd and HTML, and your Study 2 Rmd and HTML to Canvas no later than noon on Monday 2022-12-19
- your data, if you're not using NHANES, to Canvas no later than noon on Monday 2022-12-19
- your [Project B self-evaluation form](http://localhost:4641/self_eval.html) after you submit your Canvas materials, and no later than noon Monday 2022-12-19
- your CWRU class evaluation by their deadline, which is Wednesday 2022-12-21 at 11:59 PM.

The presentations completed on Monday and Tuesday were generally very nice, and I was especially pleased by the thoughtful work on display. Thanks and good luck to you all!
