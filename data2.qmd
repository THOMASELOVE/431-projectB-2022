...
3. You will need to use the **nhanesA** package in R to import and work with the available data. I've recently added this package to our list of recommended installations.
