...
1. Complete the Project B [Registration Form](register.html) to obtain my approval for your plan, let me know if you're working with a partner, and schedule your oral presentation.
...
3. You will build two R Markdown and HTML reports (separate reports for [Study 1](study1a.html) and [Study 2](study2a.html)) due at the time specified on the Coure Calendar.
...
4. Finally, complete the Project B [Self-Evaluation](self_eval.html) form, also due at the same time as the Final Reports for Study 1 and Study 2, as specified on the Course Calendar.
