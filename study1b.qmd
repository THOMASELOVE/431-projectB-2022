...
- a meaningful title that does not use any of "Project B", "Study 1" or "431". I want a real title, that at least describes what you're doing - be more specific than just "Exploring NHANES 2017-18 Responses".
...
As the final section of your report (which should be section 8), include the session information (using your favorite approach) as a separate section at the end of your report.
